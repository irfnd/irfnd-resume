...
describe('EducationSection', () => {
		...
		educations: [
			{
				...
				award: [{ label: 'Best Thesis', description: 'Machine Learning Project', icon: null }],
			},
			{
	...
	it('should render institution name without link when not provided', () => {
		render(<EducationSection education={mockEducation} />);
	...
	it('should render summary text with resolved placeholders', () => {
		render(<EducationSection education={mockEducation} />);
	...
	it('should handle empty summary, points, and awards gracefully', () => {
		render(<EducationSection education={mockEducation} />);
		expect(screen.getByText('HIGH SCHOOL')).toBeInTheDocument();
