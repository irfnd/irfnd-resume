...
export function ProfileFocus() {
	...
	return (
		<section id='profile-focus'>
			<div className='flex items-center justify-between mb-8'>
				<h2 className='text-lg font-semibold text-slate-900 dark:text-white tracking-tight'>{about.title}</h2>
				<div className='h-px bg-slate-200 dark:bg-neutral-800 flex-1 ml-6' />
			</div>

			<div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
				<div className='glass-card bg-white/60 dark:bg-white/5 border border-white/50 dark:border-white/5 p-6 md:p-8 rounded-2xl md:col-span-3 light-shadow hover:light-shadow dark:shadow-none hover:border-blue-300/50 dark:hover:border-blue-500/20 transition-colors'>
				...
				{about.focus.map((item, index) => (
					...
					>
						...
						<div>
							...
							<div className='text-xs text-slate-500 dark:text-neutral-400 uppercase tracking-wider mt-1 font-semibold'>
								{item.label}
							</div>
						</div>
					</div>
