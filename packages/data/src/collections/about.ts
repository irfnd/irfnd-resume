...
export const about: I18nData<AboutData> = {
	en: {
		title: 'Profile & Focus',
		description: [
			{
	...
	id: {
		...
		focus: [
			{ value: '3+ Tahun', label: 'Pengalaman Kerja', icon: 'tabler:code' },
			{ value: 'Full-Cycle', label: 'Development', icon: 'tabler:stack-2' },
			{ value: 'Presisi', label: 'UI/UX Engineering', icon: 'tabler:viewfinder' },
		],
	},
};
